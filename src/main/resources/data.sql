...
values
        ...
        (29, 28, 30, 1, 4, 'Kimyoviy bog''lanish turlari. Kristall panjaralar', 'Виды химических связей. Кристаллические решетки', now(), now()),
            ...
            (32, 31, 33, 29, 3, 'Bog''lanish turlari: kovalent (qutbli va qutbsiz, donor - akseptor), metall, ionli, vodorod', 'Виды связей: ковалентная (полярная и неполярная, донорно-акцепторная), металлическая, ионная, водородная', now(), now()),
            (33, 32, 34, 29, 4, 'Kristall panjara turlari, kristall va amorf moddalar, tuzilish formulalari, sigma- va pi-bog''lanishlar', 'Типы кристаллических решеток, кристаллические и аморфные вещества, структурные формулы, сигма- и пи-связи', now(), now()),

        (34, 33, 35, 1, 5, 'Kimyoviy reaksiyalarning kinetikasi. Kimyoviy muvozanat', 'Кинетика химических реакций. Химическое равновесие', now(), now()),
            (35, 34, 36, 34, 1, 'Reaksiya tezligi va unga ta''sir etuvchi omillar (modda tabiati, gaz va suyuq moddalar konsentratsiyasi, bosim, hajm, harorat)', 'Скорость реакции и факторы, влияющие на нее (природа вещества, концентрация газообразных и жидких веществ, давление, объем, температура)', now(), now()),
            (36, 35, 37, 34, 2, 'Kataliz va katalizator. Fermentlar, ingibitor haqida tushuncha', 'Катализ и катализатор. Понятие о ферментах, ингибиторе', now(), now()),
            (37, 36, 38, 34, 3, 'Qaytar va qaytmas reaksiyalar, to''g''ri va teskari reaksiyalar', 'Обратимые и необратимые реакции, прямые и обратные реакции', now(), now()),
            (38, 37, 39, 34, 4, 'Kimyoviy muvozanat va uning siljishi. Le-Shatelye prinsipi', 'Химическое равновесие и его сдвиг. Принцип Ле Шателье', now(), now()),
            (39, 38, 40, 34, 5, 'Kimyoviy muvozanatga bosimning, konsentratsiyaning va haroratning ta''siri', 'Влияние давления, концентрации и температуры на химическое равновесие', now(), now()),

        (40, 39, 41, 1, 6, 'Eritmalar', 'Растворы', now(), now()),
            (41, 40, 42, 40, 1, 'Eritmaning aralashma va kimyoviy birikma bilan o''xshashligi va farqi', 'Сходства и различия раствора со смесью и химического соединения', now(), now()),
            (42, 41, 43, 40, 2, 'Eritma tarkibidagi erigan modda miqdoriga ko''ra eritmalarning turlari', 'Виды растворов по количеству растворенного вещества в растворе', now(), now()),
            (43, 42, 44, 40, 3, 'Eritmalar konsentratsiyalarini ifodalash usullari (massa ulush, foiz konsentratsiya, molar va normal konsentratsiyalar)', 'Методы выражения концентраций растворов (массовая доля, процентная концентрация, молярная и нормальная концентрации)', now(), now()),
            (44, 43, 45, 40, 4, 'Foiz va molar, foiz va normal konsentratsiya o''rtasidagi bog''lanish', 'Связь между процентом и молярной, процентом и нормальной концентрацией', now(), now()),
            (45, 44, 46, 40, 5, 'Eruvchanlik koeffitsiyenti', 'Коэффициент растворимости', now(), now()),
            (46, 45, 47, 40, 6, 'To''yingan, to''yinmagan, o''ta to''yingan eritmalar', 'Насыщенные, ненасыщенные, пересыщенные растворы', now(), now()),
            (47, 46, 48, 40, 7, 'Kristallogidratlar', 'Кристаллогидраты', now(), now()),
            (48, 47, 49, 40, 8, 'Kimyoviy moddalarning amaliy ahamiyati', 'Практическое значение химических веществ', now(), now()),

        (49, 48, 50, 1, 7, 'Elektrolitik dissotsiatsiyalanish nazariyasi', 'Теория электролитической диссоциации', now(), now()),
            (50, 49, 51, 49, 1, 'Elektrolitik dissotsiatsiyalanish nazariyasi. Elektrolitlar va noelektrolitlar', 'Теория электролитической диссоциации. Электролиты и неэлектролиты', now(), now()),
            (51, 50, 52, 49, 2, 'Kislota, ishqor va tuzlarning dissotsiatsiyalanishi', 'Диссоциация кислоты, щелочи и солей', now(), now()),
            (52, 51, 53, 49, 3, 'Elektrolitlarning dissotsiatsiyalanish darajasi', 'Степень диссоциации электролитов', now(), now()),
            (53, 52, 54, 49, 4, 'Ionlar: kation va anionlar', 'Ионы: катионы и анионы', now(), now()),
            (54, 53, 55, 49, 5, 'Kuchli va kuchsiz elektrolitlar', 'Сильные и слабые электролиты', now(), now()),
            (55, 54, 56, 49, 6, 'Dissotsiatsiyalanish konstantasi, ion almashinish reaksiyalari, qisqa va to''liq ionli tenglamalar', 'Константа диссоциации, реакции ионного обмена, краткие и полные ионные уравнения', now(), now()),
            (56, 55, 57, 49, 7, 'Suvning ion ko''paytmasi, pH va pOH', 'Ионное произведение воды, pH и pOH', now(), now()),
            (57, 56, 58, 49, 8, 'Tuzlar gidrolizi, tuzlar gidrolizlanganda sodir bo''ladigan jarayonlar va undagi eritma muhiti', 'Гидролиз солей, процессы, происходящие при гидролизе солей и среда их растворения', now(), now()),

        (58, 57, 59, 1, 8, 'Oksidlanish-qaytarilish reaksiyalari', 'Окислительно-восстановительные реакции', now(), now()),
            (59, 58, 60, 58, 1, 'Oksidlanish darajasi', 'Уровень окисления', now(), now()),
            (60, 59, 61, 58, 2, 'Oksidlanish-qaytarilish reaksiyalari (oksidlanish hamda qaytarilish jarayonlari, oksidlovchi va qaytaruvchilar)', 'Окислительно-восстановительные реакции (процессы окисления и восстановления, окислители и восстановители)', now(), now()),
            (61, 60, 62, 58, 3, 'Oksidlanish-qaytarilish reaksiyalarini tenglash usullari – elektron balans va yarim reaksiya usuli', 'Методы балансирования окислительно-восстановительных реакций – электронный баланс и метод полуреакций', now(), now()),

        (62, 61, 63, 1, 9, 'Elektroliz', 'Электролиз', now(), now()),
            (63, 62, 64, 62, 1, 'Elektroliz va unda sodir bo''ladigan jarayonlar', 'Электролиз и процессы, происходящие в нем', now(), now()),
            (64, 63, 65, 62, 2, 'Katod va anod, inert elektrodlar, eruvchan va erimaydigan anodlar', 'Катод и анод, инертные электроды, растворимые и нерастворимые аноды', now(), now()),
            (65, 64, 66, 62, 3, 'Faradey soni. Eritma va suyuqlanma elektrolizi', 'Число Фарадея. Электролиз раствора и сжижения', now(), now()),
            (66, 65, 67, 62, 4, 'Katodda sodir bo''ladigan qaytarilish jarayoni, anodda sodir bo''ladigan oksidlanish jarayoni', 'Процесс восстановления, происходящий на катоде, процесс окисления, происходящий на аноде', now(), now()),
            (67, 66, 68, 62, 5, 'Metallarning aktivlik qatori. Elektrolizga doir Faradey qonunlari', 'Ряд активности металлов. Законы электролиза Фарадея', now(), now());

-- 2-MODULE
insert into topics (id, prev_id, next_id, seq, title_uz, title_ru, created_at, updated_at)
values (68, 67, 69, 2, 'Anorganik kimyo', 'Неорганическая химия', now(), now());

insert into topics (id, prev_id, next_id, parent_id, seq, title_uz, title_ru, created_at, updated_at)
values
        (69, 68, 70, 68, 1, 'Anorganik moddalarning eng muhim sinflari', 'Важнейшие классы неорганических веществ', now(), now()),
            (70, 69, 71, 69, 1, 'Oksidlarning tarkibi, tuzilishi, nomlanishi va ularning turlari; olinish usullari va xossalari', 'Состав, строение, наименование и типы оксидов; методы получения и свойства', now(), now()),
            (71, 70, 72, 69, 2, 'Asoslarning tarkibi, tuzilishi, nomlanishi va ularning turlari; olinish usullari va xossalari', 'Состав, структура, наименование и типы оснований; методы получения и свойства', now(), now()),
            (72, 71, 73, 69, 3, 'Kislotalarning tarkibi, tuzilishi, nomlanishi va turlari; olinish usullari va xossalari', 'Состав, строение, наименование и типы кислот; методы получения и свойства', now(), now()),
            (73, 72, 74, 69, 4, 'Tuzlarning tarkibi, tuzilishi, nomlanishi va ularning turlari; olinish usullari va xossalari', 'Состав, строение, наименование солей и их типы; методы получения и свойства', now(), now()),
            (74, 73, 75, 69, 5, 'Eng muhim oksidlar, asoslar, kislotalar va tuzlarning ishlatilishi', 'Наиболее важные области применения оксидов, оснований, кислот и солей', now(), now()),
            (75, 74, 76, 69, 6, 'Anorganik moddalarning eng muhim sinflari o''rtasidagi genetik bog''lanish', 'Генетические связи между важнейшими классами неорганических веществ', now(), now()),

        (76, 75, 77, 68, 2, 'Metallmaslar', 'Неметаллы', now(), now()),
            (77, 76, 78, 76, 1, 'Metallmaslarning davriy sistemada joylashishi, tabiatda tarqalishi, metallmaslarning tabiiy oilalari, olinish usullari va ishlatilishi', 'Размещение неметаллов в периодической системе, распространение в природе, естественные семейства металлов, способы получения и использования', now(), now()),
            (78, 77, 79, 76, 2, 'Metallmaslarning fizik va kimyoviy xossalari, ularning birikmalari', 'Физико-химические свойства неметаллов, их соединений', now(), now()),
            (79, 78, 80, 76, 3, 'Kislorod va uning izotoplari, allotropiyasi, olinish usullari va xossalari', 'Кислород и его изотопы, аллотропия, способы получения и свойства', now(), now()),
            (80, 79, 81, 76, 4, 'Vodorod va uning izotoplari, olinish usullari va xossalari', 'Водород и его изотопы, способы получения и свойства', now(), now()),
            (81, 80, 82, 76, 5, 'Uglerod va uning eng muhim birikmalari, uglerod guruhchasi metallmaslari', 'Углерод и его важнейшие соединения, металлы углеродной подгруппы', now(), now()),
            (82, 81, 83, 76, 6, 'Azot va uning birikmalari, nitrat kislotani olinish usullari hamda xossalari, nitratlar, azot guruhchasi metallmaslari', 'Азот и его соединения, способы и свойства производства азотной кислоты, нитраты, неметаллы азотной группы', now(), now()),
            (83, 82, 84, 76, 7, 'Xalkogenlar, oltingugurt va oltingugurt birikmalarining xossalari, sulfat kislotaning olinish usullari hamda xossalari, oleum. Sulfat va nitrat kislotalarni sanoatda ishlab chiqarish', 'Свойства халькогенов, серы и сернистых соединений, способы получения и свойства серной кислоты, олеума. Промышленное производство серной и азотной кислот', now(), now()),
            (84, 83, 85, 76, 8, 'Galogenlar va nodir gazlar, ularning tabiatda tarqalishi, olinish usullari hamda xossalari', 'Галогены и редкие газы, их распространение в природе, способы получения и свойства', now(), now()),
            (85, 84, 86, 76, 9, 'Mineral o''g''itlar. Makro va mikroelementlar, oddiy va kompleks o''g''itlar. Azotli, fosforli va kaliyli o''g''itlar, ularda ozuqa elementining miqdorini hisoblash. Biogen elementlar va ularning tirik organizmlardagi ahamiyati', 'Минеральные удобрения. Макро- и микроэлементы, простые и сложные удобрения. Азотные, фосфорные и калийные удобрения, расчет количества в них питательных веществ. Биогенные элементы и их значение в живых организмах', now(), now()),

        (86, 85, 87, 68, 3, 'Metallar', 'Металлы', now(), now()),
            (87, 86, 88, 86, 1, 'Metallarning davriy jadvaldagi o''rni, tabiatda tarqalishi, olinish usullari va ishlatilshi', 'Место металлов в таблице Менделеева, распространение в природе, способы добычи и использования', now(), now()),
            (88, 87, 89, 86, 2, 'Metallarning fizik va kimyoviy xossalari, ularning birikmalari', 'Физико-химические свойства металлов, их соединений', now(), now()),
            (89, 88, 90, 86, 3, 'Ishqoriy va ishqoriy-yer metallar. Ularning olinish usullari, xossalari, birikmalari va ishlatilishi', 'Щелочные и щелочноземельные металлы. Способы их получения, свойства, соединения и применение', now(), now()),
            (90, 89, 91, 86, 4, 'Suvning qattiqligi va uni yo''qotish usullari', 'Жесткость воды и способы ее устранения', now(), now()),
            (91, 90, 92, 86, 5, 'Aluminiy', 'Алюминий', now(), now()),
            (92, 91, 93, 86, 6, 'I guruhning yonaki guruhchasi (Cu, Ag, Au)', 'Боковая группа I группы (Cu, Ag, Au)', now(), now()),
            (93, 92, 94, 86, 7, 'II guruhning yonaki guruhchasi elementlari (Zn, Cd, Hg)', 'Элементы боковой группы II группы (Zn, Cd, Hg)', now(), now()),
            (94, 93, 95, 86, 8, 'Xrom, marganes, temir metallarining xossalari, ularning eng asosiy birikmalarining olinishi, xossalari, ishlatilishi', 'Свойства металлов хрома, марганца, железа, получение их основных соединений, свойства, применение', now(), now()),
            (95, 94, 96, 86, 9, 'Metallar korroziyasi va ularni korroziyadan himoyalash usullari', 'Коррозия металлов и методы защиты их от коррозии', now(), now()),
            (96, 95, 97, 86, 10, 'Qotishmalar. Cho''yan va po''lat ishlab chiqarish', 'Сплавы. Производство чугуна и стали', now(), now()),
            (97, 96, 98, 86, 11, 'Kompleks birikmalar', 'Комплексные соединения', now(), now());

-- 3-MODULE
insert into topics (id, prev_id, next_id, seq, title_uz, title_ru, created_at, updated_at)
values (98, 97, 99, 3, 'Organik kimyo', 'Органическая химия', now(), now());

insert into topics (id, prev_id, next_id, parent_id, seq, title_uz, title_ru, created_at, updated_at)
values
        (99, 98, 100, 98, 1, 'Organik kimyoning asosiy tushuncha va qonunlari. To''yingan uglevodorodlar', 'Основные понятия и законы органической химии. Насыщенные углеводороды', now(), now()),
            (100, 99, 101, 99, 1, 'Organik kimyoning asosiy tushuncha va qonunlari. Organik birikmalarning o''ziga xos xususiyatlari', 'Основные понятия и законы органической химии. Особые свойства органических соединений', now(), now()),
            (101, 100, 102, 99, 2, 'A.M.Butlerovning organik birikmalarning kimyoviy tuzilish nazariyasi', 'Теория химического строения органических соединений А.М. Бутлерова', now(), now()),
            (102, 101, 103, 99, 3, 'Organik birikmalarning sinflanishi', 'Классификация органических соединений', now(), now()),
            (103, 102, 104, 99, 4, 'Organik birikmalarga xos reaksiya turlari, izomeriya va uning turlari', 'Типы реакций, характерные для органических соединений, изомерия и ее виды', now(), now()),
            (104, 103, 105, 99, 5, 'To''yingan uglevodorodlar', 'Насыщенные углеводороды', now(), now()),
            (105, 104, 106, 99, 6, 'Alkanlar. Ularning tuzilishi, gomologik qatori, izomeriyasi, nomenklaturasi, olinish usullari, xossalari hamda ishlatilishi', 'Алканы. Их строение, гомологический ряд, изомерия, номенклатура, способы получения, свойства и применение', now(), now()),
            (106, 105, 107, 99, 7, 'Sikloalkanlar. Ularning tuzilishi, gomologik qatori, izomeriyasi, nomenklaturasi, olinish usullari, xossalari hamda ishlatilishi', 'Циклоалканы. Их строение, гомологический ряд, изомерия, номенклатура, способы получения, свойства и применение', now(), now()),

        (107, 106, 108, 98, 2, 'To''yinmagan uglevodorodlar', 'Ненасыщенные углеводороды', now(), now()),
            (108, 107, 109, 107, 1, 'Alkenlar. Ularning tuzilishi, gomologik qatori, izomeriyasi, nomenklaturasi, olinish usullari, xossalari hamda ishlatilishi', 'Алкены. Их строение, гомологический ряд, изомерия, номенклатура, способы получения, свойства и применение', now(), now()),
            (109, 108, 110, 107, 2, 'Alkadiyenlar. Ularning tuzilishi, gomologik qatori, izomeriyasi, nomenklaturasi, olinish usullari, xossalari hamda ishlatilishi', 'Алкадиены. Их строение, гомологический ряд, изомерия, номенклатура, способы получения, свойства и применение', now(), now()),
            (110, 109, 111, 107, 3, 'Alkinlar. Ularning tuzilishi, gomologik qatori, izomeriyasi, nomenklaturasi, olinish usullari, xossalari hamda ishlatilishi', 'Алкины. Их строение, гомологический ряд, изомерия, номенклатура, способы получения, свойства и применение', now(), now()),
            (111, 110, 112, 107, 4, 'Aromatik uglevodorodlarning tuzilishi, gomologik qatori, izomeriyasi, nomenklaturasi, olinish usullari, xossalari hamda ishlatilishi', 'Строение, ряд гомологии, изомерия, номенклатура, способы получения, свойства и применение ароматических углеводородов', now(), now()),
            (112, 111, 113, 107, 5, 'Organik birikmalarda uglerod atomining gibridlanishi', 'Гибридизация атома углерода в органических соединениях', now(), now()),
            (113, 112, 114, 107, 6, 'Uglevodorodlarning tabiiy manbalari. Neft, tabiiy gaz va toshko''mir', 'Природные источники углеводородов. Нефть, природный газ и уголь', now(), now()),

        (114, 113, 115, 98, 3, 'Kislorodli organik birikmalar', 'Кислородсодержащие органические соединения', now(), now()),
            (115, 114, 116, 114, 1, 'To''yingan bir atomli va ko''p atomli spirtlar. Ularning tuzilishi, gomologik qatori, izomeriyasi, nomenklaturasi, olinish usullari, xossalari hamda ishlatilishi', 'Насыщенные одноатомные и многоатомные спирты. Их строение, гомологический ряд, изомерия, номенклатура, способы получения, свойства и применение', now(), now()),
            (116, 115, 117, 114, 2, 'Fenollar va aromatik spirtlar. Ularning tuzilishi, gomologik qatori, izomeriyasi, nomenklaturasi, olinish usullari, xossalari hamda ishlatilishi', 'Фенолы и ароматические спирты. Их строение, гомологический ряд, изомерия, номенклатура, способы получения, свойства и применение', now(), now()),
            (117, 116, 118, 114, 3, 'Aldegidlar va ketonlar. Ularning tuzilishi, gomologik qatori, izomeriyasi, nomenklaturasi, olinish usullari, xossalari hamda ishlatilishi', 'Альдегиды и кетоны. Их строение, гомологический ряд, изомерия, номенклатура, способы получения, свойства и применение', now(), now()),

        (118, 117, 119, 98, 4, 'Karbon kislotalar, efirlar va uglevodlar', 'Карбоновые кислоты, эфиры и углеводы', now(), now()),
            ...
            (120, 119, 121, 118, 2, 'Oddiy va murakkab efirlar. Ularning tuzilishi, gomologik qatori, izomeriyasi, nomenklaturasi, tabiatda tarqalishi, olinish usullari, xossalari hamda ishlatilishi', 'Простые и сложные эфиры. Их строение, гомологический ряд, изомерия, номенклатура, распространение в природе, способы получения, свойства и применение', now(), now()),
            (121, 120, 122, 118, 3, 'Yog''lar, sovun va yuvish vositalari. Ularning tuzilishi, gomologik qatori, izomeriyasi, nomenklaturasi, tabiatda tarqalishi, olinish usullari, xossalari hamda ishlatilishi', 'Масла, мыло и моющие средства. Их строение, гомологический ряд, изомерия, номенклатура, распространение в природе, способы получения, свойства и применение', now(), now()),
            (122, 121, 123, 118, 4, 'Uglevodlar. Monosaxaridlar, disaxaridlar, polisaxaridlarning tuzilishi, izomeriyasi, nomenklaturasi, olinish usullari, xossalari hamda ishlatilishi', 'Углеводы. Строение, изомерия, номенклатура, способы получения, свойства и применение моносахаридов, дисахаридов, полисахаридов', now(), now()),

        (123, 122, 124, 98, 5, 'Azotli organik birikmalar. Yuqori molekulyar birikmalar', 'Азотные органические соединения. Высокомолекулярные соединения', now(), now()),
            (124, 123, 125, 123, 1, 'Nitrobirikmalar va aminlar. Ularning tuzilishi, nomenklaturasi, olinishi, xossalari va ishlatilishi', 'Нитросоединения и амины. Их строение, номенклатура, получение, свойства и применение', now(), now()),
            (125, 124, 126, 123, 2, 'Aromatik aminlar. Ularning tuzilishi, nomenklaturasi, olinishi, xossalari va ishlatilishi', 'Ароматические амины. Их строение, номенклатура, получение, свойства и применение', now(), now()),
            (126, 125, 127, 123, 3, 'Aminokislotalar va ularning olinishi, xossalari', 'Аминокислоты и их получение, свойства', now(), now()),
            (127, 126, 128, 123, 4, 'Oqsillarning tuzilishi va xossalari, biologik ahamiyati', 'Строение и свойства белков, биологическое значение', now(), now()),
            (128, 127, 129, 123, 5, 'Tabiiy, sintetik va sun''iy yuqori molekular birikmalar', 'Природные, синтетические и искусственные высокомолекулярные соединения', now(), now()),
            (129, 128, 130, 123, 6, 'Polimerlar, polimerlanish va polikondensatlanish reaksiyalari', 'Полимеры, реакции полимеризации и поликонденсации', now(), now()),
            (130, 129, 131, 123, 7, 'Makromolekula, polimerlanish darajasi, polimerlarning olinishi va tuzilishi, kauchuk va tolalar', 'Макромолекула, степень полимеризации, получение и структура полимеров, каучуков и волокон', now(), now()),
            (131, 130, 132, 123, 8, 'Eng muhim plastmassalarga umumiy tavsif. Eng muhim sintetik kauchuklar, ularning xossalari va ishlatilishi', 'Общее описание важнейших пластмасс. Важнейшие синтетические каучуки, их свойства и применение', now(), now());

-- 4-MODULE
insert into topics (id, prev_id, next_id, seq, title_uz, title_ru, created_at, updated_at)
values (132, 131, 133, 4, 'Amaliy mashg''ulot va laboratoriya tajribalari', 'Практические занятия и лабораторные эксперименты', now(), now());

insert into topics (id, prev_id, next_id, parent_id, seq, title_uz, title_ru, created_at, updated_at)
values
        (133, 132, 134, 132, 1, 'Kimyo xonasida jihozlar va reaktivlar bilan ishlashda xavfsizlik qoidalari', 'Правила безопасности при работе с оборудованием и реактивами в химическом кабинете', now(), now()),
        (134, 133, 135, 132, 2, 'Kimyo laboratoriya jihozlarining turlari va ulardan foydalanish tartibi', 'Виды химического лабораторного оборудования и их применение', now(), now()),
        (135, 134, 136, 132, 3, 'Geterogen aralashmalarni ajratish usullari (tindirish, filtrlash, bug''latish, magnit yordamida ajratish, distillash)', 'Методы разделения гетерогенных смесей (разделение, фильтрация, выпаривание, магнитная сепарация, перегонка)', now(), now()),
        (136, 135, 137, 132, 4, 'Fizik xossalari turlicha bo''lgan moddalarni bir-biridan farqlash', 'Различать вещества с разными физическими свойствами', now(), now()),
        (137, 136, 138, 132, 5, 'Laboratoriya sharoitida vodorod gazini olish, vodorodning mis (II) – oksid bilan o''zaro ta''siri', 'Получение газообразного водорода в лабораторных условиях, взаимодействие водорода с медью(II) - оксидом', now(), now()),
        (138, 137, 139, 132, 6, 'Laboratoriya sharoitida turli konsentratsiyali eritmalarni tayyorlash', 'Приготовление растворов различной концентрации в лабораторных условиях', now(), now()),
        (139, 138, 140, 132, 7, 'Galogenidlar, sulfat, karbonat, fosfat, ammoniy va galogen ionlari, turli metall kationlari uchun sifat reaksiyalari', 'Качественные реакции на галогениды, сульфат, карбонат, фосфат, ионы аммония и галогенов, катионы различных металлов', now(), now()),
        (140, 139, 141, 132, 8, 'Asoslar va kislotalar, va boshqa kimyoviy moddalar eritmalarining indikatorlar rangini o''zgartirishi', 'Изменение цвета индикаторов растворов оснований и кислот и других химических веществ', now(), now()),
        (141, 140, 142, 132, 9, 'Turli metall oksidlarining kislotalar bilan ta''sirlashuvi', 'Реакция оксидов различных металлов с кислотами', now(), now()),
        (142, 141, 143, 132, 10, 'Reaksiyalarining borish shart-sharoitlari', 'Условия для реакций', now(), now()),
        (143, 142, 144, 132, 11, 'Oksidlarning suv bilan o''zaro ta''sirlashuvidan olingan eritmalarda indikatorlar rangining o''zgarishi', 'Изменение цвета индикаторов в растворах, полученных при взаимодействии оксидов с водой', now(), now()),
        (144, 143, 145, 132, 12, 'Suvda erimaydigan asoslarning kislotalar bilan o''zaro ta''siri', 'Взаимодействие нерастворимых в воде оснований с кислотами', now(), now()),
        (145, 144, 146, 132, 13, 'Suvda erimaydigan asoslarning qizdirilganda parchalanishi', 'Разложение нерастворимых в воде оснований при нагревании', now(), now()),
        (146, 145, 147, 132, 14, 'Metall gidroksidlarining olinishi, ularga kislota va ishqor eritmalarining ta''siri', 'Производство гидроксидов металлов, действие на них растворов кислот и щелочей', now(), now()),
        (147, 146, 148, 132, 15, 'Kislotalarning metallar, asoslar, tuzlar bilan o''zaro ta''siri', 'Взаимодействие кислот с металлами, основаниями, солями', now(), now()),
        (148, 147, 149, 132, 16, 'Tuz eritmalari bilan metallarning o''zaro ta''siri', 'Взаимодействие металлов с растворами солей', now(), now()),
        (149, 148, 150, 132, 17, 'Al, Cu, Zn, Cr, Fe metallarining suvda eriydigan tuzlari va ular asosida boradigan tajribalar', 'Водорастворимые соли металлов Al, Cu, Zn, Cr, Fe и опыты на их основе', now(), now()),
        (150, 149, 151, 132, 18, 'Laboratoriya sharoitida ammiak va karbonat angidrid olish va ularning kimyoviy xossalarini tekshirish', 'Получение аммиака и углекислого газа в лабораторных условиях и проверка их химических свойств', now(), now()),
        (151, 150, 152, 132, 19, 'Laboratoriya sharoitida organik moddalarning olinishi va ularga xos sifat reaksiyalari', 'Получение органических веществ и характерные для них качественные реакции в лабораторных условиях', now(), now()),
        (152, 151, 153, 132, 20, 'Organik moddalarni olinishi va ular uchun sifat reaksiyalari', 'Получение органических веществ и качественные реакции на них', now(), now()),
        (153, 152, 154, 132, 21, 'Glitserin va glukoza uchun sifat reaksiya', 'Качественная реакция на глицерин и глюкозу', now(), now()),
        (154, 153, 155, 132, 22, 'Oqsillarga xos rangli reaksiyalar', 'Цветовые реакции, специфичные для белков', now(), now());

-- 5-MODULE
insert into topics (id, prev_id, next_id, seq, title_uz, title_ru, created_at, updated_at)
values (155, 154, 156, 5, 'Reaksiyalar zanjiri asosida moddalarning o''zaro bir-biriga ta''sir o''tkazishi', 'Взаимодействие веществ на основе цепочки реакций', now(), now());

insert into topics (id, prev_id, next_id, parent_id, seq, title_uz, title_ru, created_at, updated_at)
values
        (156, 155, 157, 155, 1, 'Anorganik moddalarning eng muhim sinflari o''rtasida o''zaro genetik bog''lanish', 'Генетические взаимоотношения между важнейшими классами неорганических веществ', now(), now()),
        (157, 156, 158, 155, 2, 'Organik moddalar o''rtasida boradigan kimyoviy jarayonlar', 'Химические процессы между органическими веществами', now(), now()),
        (158, 157, 159, 155, 3, 'Noorganik va organik kimyodan olingan bilimlarni umumlashtirish', 'Обобщение знаний по неорганической и органической химии', now(), now()),
        (159, 158, 160, 155, 4, 'Kimyoviy reaksiyalarning qonuniyatlari haqidagi bilimlarni umumlashtirish orqali kimyoviy ishlab chiqarishning umumiy ilmiy asoslari yuzasidan olingan bilimlarni sistemaga solish', 'Систематизация полученных знаний по общенаучным основам химического производства путем обобщения знаний о законах химических реакций', now(), now()),
        (160, 159, null, 155, 5, 'O''zbekistonda kimyo fani va kimyo sanoatining rivojlanish istiqbollari', 'Перспективы развития химической науки и химической промышленности в Узбекистане', now(), now());
